...
public:
    ...
    static void setexecutaTZS_FS(int _executaTZS_FS);
    static void setexecutaTZS_RS(int _executaTZS_RS);
    static void setexecutaTZS_RF(int _executaTZS_RF);
    static void setexecutaAffine(int _executaAffine);
    static void setexecutaAME4par(int _executaAME4par);
    static void setexecutaAME6par(int _executaAME6par);
