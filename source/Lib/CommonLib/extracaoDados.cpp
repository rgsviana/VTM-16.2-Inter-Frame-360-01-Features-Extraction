...
int extracaoDados::flagBDOFmerge;
    ...
    int extracaoDados::executaTZS_FS;
    int extracaoDados::executaTZS_RS;
    int extracaoDados::executaTZS_RF;
    int extracaoDados::executaAffine;
    int extracaoDados::executaAME4par;
    int extracaoDados::executaAME6par;
    ...
    void extracaoDados::setexecutaTZS_FS(int _executaTZS_FS){ executaTZS_FS = _executaTZS_FS; }
    void extracaoDados::setexecutaTZS_RS(int _executaTZS_RS){ executaTZS_RS = _executaTZS_RS; }
    void extracaoDados::setexecutaTZS_RF(int _executaTZS_RF){ executaTZS_RF = _executaTZS_RF; }
    void extracaoDados::setexecutaAffine(int _executaAffine){ executaAffine = _executaAffine; }
    void extracaoDados::setexecutaAME4par(int _executaAME4par){ executaAME4par = _executaAME4par; }
    void extracaoDados::setexecutaAME6par(int _executaAME6par){ executaAME6par = _executaAME6par; }
...
//RAMIRO: Features imagem (fim)
    ...
    void extracaoDados::inicializaFeatures(){
        ...
        */
        ...
        executaTZS = 111111;
        executaTZS_FS = 111111;
        executaTZS_RS = 111111;
        executaTZS_RF = 111111;
        executaAffine = 111111;
        executaAME4par = 111111;
        executaAME6par = 111111;
    }
#endif
